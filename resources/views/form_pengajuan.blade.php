                ...
                <div x-show="currentStep === 2" x-transition class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            ...
                            <p class="text-[11px] text-gray-500 italic text-left text-transform-none" style="text-transform: none;">* Silahkan ubah NIK jika anda mengajukan anggota lain, dan isi NIK Anda jika anak belum mempunyai NIK.</p>
                        </div>
                        <div class="space-y-1">
                        ...
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <template x-for="item in listLayanan" :key="item.id">
                                    ...
                                    >
                                        <input type="checkbox" :value="item.id" x-model="formData.selectedLayanan" class="w-5 h-5 accent-green-600">
                ...
                <div x-show="currentStep === 3" class="space-y-4" 
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-3.5 rounded-r-xl shadow-sm mb-3">
                        <div class="flex items-start text-blue-800 mb-2">
                            ...
                            <div>
                                <h4 class="font-bold text-sm">Informasi Persyaratan Dokumen :</h4>
                                <p class="text-[11px] text-blue-700 mt-0.5">Silakan lengkapi berkas persyaratan asli sesuai layanan yang Anda pilih di bawah ini:</p>
                            </div>
                        </div>
                            ...
                            <template x-for="id in formData.selectedLayanan" :key="id">
                                <div class="bg-white/60 rounded-lg py-2 px-3 border border-blue-100/50 shadow-xs">
                                    <div class="font-bold text-xs text-blue-950 mb-0 flex items-center">
                                        ...
                                        <span x-text="listLayanan.find(l => l.id == id)?.nama"></span>
                                    </div>
                                    
                                    <!-- List Persyaratan -->
                                    <div class="text-[11px] text-gray-700 leading-relaxed pl-4 font-semibold">
                                        <span class="whitespace-pre-line block" x-text="(listPersyaratan.find(s => s.id == id)?.deskripsi_syarat || 'Persyaratan tidak spesifik.').trim()"></span>
                                    </div>
                                </div>
                            </template>
                        </div>
    ...
    submitForm() {
        ...
        .catch(error => {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Gagal mengirim data. Cek koneksi internet.'
            });
